...
@section('content')
    {{ Breadcrumbs::render('edit-task', $task) }}
    ...
    <form class="w-full max-w-lg" method="POST" action="{{ route('tasks.update', ['task' => $task->id]) }}" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full px-3 mb-6">
                ...
                <textarea class="appearance-none block w-full text-gray-700 border border-gray-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48" id="description" name="description" type="text">{{ $task->description }}</textarea>
            </div>
