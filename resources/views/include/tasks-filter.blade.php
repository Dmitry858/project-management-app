<form class="w-full filter" method="GET" action="">
    ...
    <div class="flex flex-wrap items-center -mx-3 mb-3">
        ...
        <a class="inline-block border border-blue-600 hover:bg-blue-600 text-blue-600 hover:text-white font-bold ml-3 py-2 px-4 rounded focus:outline-none focus:shadow-outline" href="{{ route('tasks.index') }}">
            @lang('buttons.reset')
        </a>
    </div>
</form>
